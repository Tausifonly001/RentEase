...
?>
<!DOCTYPE html>
<html lang="en" class="h-full bg-white selection:bg-teal-100">
<head>
    <meta charset="UTF-8">
...
<body class="h-full gradient-bg overflow-hidden flex items-center justify-center">
    ...
    <div class="max-w-xl w-full px-6 text-center">
        ...
        <div class="mb-8 flex justify-center scale-up-element opacity-0">
            <div class="relative">
                <div class="absolute inset-0 bg-teal-400 blur-3xl opacity-20 animate-pulse"></div>
                <div class="relative h-32 w-32 bg-white rounded-[2.5rem] shadow-2xl flex items-center justify-center border border-teal-50">
                    <span class="material-symbols-outlined text-6xl text-teal-600 font-variation-fill translate-y-1">verified</span>
                </div>
            </div>
        </div>
