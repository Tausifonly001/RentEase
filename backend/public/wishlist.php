...
<main class="flex-grow max-w-7xl mx-auto px-4 md:px-8 py-12 w-full">
    ...
    <?php if ($success): ?>
        <div class="mb-8 bg-teal-50 border border-teal-100 text-teal-700 p-4 rounded-xl flex items-center gap-3 reveal-element">
    ...
    <?php if (empty($wishlistItems)): ?>
        <div class="bg-slate-50 rounded-3xl border-2 border-dashed border-slate-200 p-20 text-center reveal-element">
    ...
    <?php else: ?>
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16 reveal-element">
            ...
            ?>
                <div class="group bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col">
                    <div class="relative aspect-[4/5] overflow-hidden bg-slate-50">
                        ...
                        <form action="wishlist.php" method="POST" class="absolute top-4 right-4">
                            ...
                            <button type="submit" class="bg-white/90 backdrop-blur-sm p-2.5 rounded-full text-red-500 hover:bg-red-500 hover:text-white transition-all shadow-sm">
