...
<main class="flex-grow pt-24 pb-20 px-6 md:px-12 max-w-3xl mx-auto min-h-screen w-full">
 <div class="bg-white p-8 rounded-3xl shadow-sm border border-border reveal-element">
 <h1 class="text-3xl font-normal text-ink mb-2">Agent Location Broadcaster</h1>
 <p class="text-muted mb-8">Broadcast your real-time location to the customer.</p>

 <div class="mb-6">
 <label class="block text-sm font-light text-ink mb-2">Order ID (UUID)</label>
 <input type="text" id="orderIdInput" class="w-full border-border rounded-xl px-4 py-3 bg-surface focus:bg-white focus:ring-2 focus:ring-teal-500" placeholder="Enter Order UUID...">
 </div>

 <div class="flex gap-4 mb-8">
 <button id="startBtn" class="flex-1 bg-champagne-dark text-white font-normal py-3 px-4 rounded-xl hover:bg-teal-700 transition shadow-lg shadow-teal-500/30 flex items-center justify-center gap-2">
 ...
 <div id="statusBox" class="bg-surface p-6 rounded-2xl border border-border text-sm font-mono text-ink font-light">
 Waiting to start...
 </div>
 </div>
</main>
