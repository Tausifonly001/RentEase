...
<div class="max-w-7xl mx-auto flex min-h-screen">
    ...
    <aside class="hidden md:flex w-64 border-r border-slate-200 bg-slate-50 flex-col p-4 gap-2">
        <div class="mb-6 px-4 pt-4">
            ...
            <p class="text-xs text-slate-500">Manage your rental experience</p>
        </div>
        <nav class="space-y-1">
            <a class="bg-teal-50 text-teal-700 font-semibold rounded-lg px-4 py-3 flex items-center gap-3 transition-all" href="settings.php">
            ...
            <a class="text-slate-600 px-4 py-3 flex items-center gap-3 hover:bg-slate-100 rounded-lg transition-all" href="coming-soon.php">
                ...
                <span class="text-sm">Membership</span>
            </a>
        </nav>
    </aside>
    ...
    <div class="flex-1 p-8 bg-white">
        <div class="max-w-4xl mx-auto">
            <!-- Header Section -->
            <header class="mb-10">
                <h1 class="font-h1 text-4xl text-primary font-bold mb-2 tracking-tight">Account Settings</h1>
            ...
            <div class="grid grid-cols-12 gap-8">
                    ...
                    <form action="api/update-profile.php" method="POST">
                        ...
                        <div class="p-8">
                            <div class="flex items-center gap-3 mb-8">
                                ...
                                <h3 class="font-h3 text-xl font-bold text-primary">Personal Information</h3>
                            </div>
                            ...
                            <div class="flex flex-col md:flex-row gap-10 items-start">
                                <div class="relative group">
                                    ...
                                    <button type="button" class="mt-4 text-teal-600 text-xs font-bold uppercase tracking-wider block text-center w-full hover:text-teal-700">Change Photo</button>
                                </div>
                                
                                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                                    <div class="flex flex-col gap-2">
                                        <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Full Name</label>
                                        <input name="full_name" class="bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all text-sm" type="text" value="<?= htmlspecialchars((string)($currentUser['user_metadata']['full_name'] ?? $currentUser['name'])) ?>"/>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Email Address</label>
                                        <input name="email" class="bg-slate-100 border border-slate-200 rounded-lg px-4 py-3 text-slate-500 outline-none text-sm cursor-not-allowed" type="email" value="<?= htmlspecialchars((string)$currentUser['email']) ?>" readonly/>
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <input name="phone" class="bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all text-sm" type="tel" placeholder="+1 (555) 000-0000"/>
                                    </div>
                                    <div class="flex flex-col gap-2">
                                        <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Date of Birth</label>
                                        <input name="dob" class="bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all text-sm" type="date"/>
                                    </div>
                                    <div class="flex flex-col gap-2 md:col-span-2">
                                        <label class="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Delivery Address</label>
                                        <textarea name="address" class="bg-slate-50 border border-slate-200 rounded-lg px-4 py-3 focus:border-secondary focus:ring-1 focus:ring-secondary outline-none transition-all text-sm" rows="2" placeholder="Street Address, Apartment, Suite, etc."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-slate-50 px-8 py-4 flex justify-end border-t border-slate-100">
                            <button type="submit" class="bg-primary text-white font-button px-8 py-2.5 rounded-lg active:scale-95 duration-150 hover:bg-primary/90 transition-all font-semibold">Save Changes</button>
                        </div>
                    </form>
                </section>
                ...
                <section class="col-span-12 lg:col-span-4 flex flex-col gap-8">
                    <div class="bg-primary text-white rounded-xl shadow-lg p-8 relative overflow-hidden">
                        ...
                        <div class="relative z-10">
                            <span class="inline-block bg-secondary px-2 py-1 rounded text-[10px] font-bold tracking-widest uppercase mb-4">Current Plan</span>
                            <h3 class="text-3xl font-bold mb-1 tracking-tight">Premium Renter</h3>
                            <div class="flex items-center gap-2 text-teal-400 mb-8">
                                <span class="material-symbols-outlined text-sm" style="font-variation-settings: 'FILL' 1;">verified</span>
                                <span class="text-xs">Member since 2022</span>
                            </div>
                            <div class="flex justify-between items-end border-t border-white/20 pt-6">
                                <div>
                                    <p class="text-[10px] font-bold opacity-70 mb-1 uppercase tracking-widest">Loyalty Points</p>
                                    <p class="text-2xl font-bold">12,450 <span class="text-xs font-normal opacity-60">pts</span></p>
                                </div>
                                <button class="text-teal-400 text-sm font-semibold hover:underline underline-offset-4">View Rewards</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-slate-50 rounded-xl p-6 border border-slate-200">
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h4 class="text-sm font-bold mb-1">Security Health</h4>
                                <p class="text-xs text-slate-500 mb-4 leading-relaxed">2FA is currently disabled. Enable it to secure your account and personal data.</p>
                                <button class="text-teal-600 text-xs font-bold flex items-center gap-1 hover:gap-2 transition-all">
                                    Enable now <span class="material-symbols-outlined text-sm">arrow_forward</span>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <section class="col-span-12 lg:col-span-7 bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <h3 class="font-h3 text-xl font-bold text-primary">Rental Preferences</h3>
                    </div>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-4 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-primary">Payment Reminders</p>
                                    <p class="text-xs text-slate-500">Get notified 3 days before your rental renewal</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-primary">Delivery & Collection Alerts</p>
                                    <p class="text-xs text-slate-500">Live tracking for scheduled furniture arrivals</p>
                                </div>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input checked class="sr-only peer" type="checkbox"/>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-lg hover:bg-slate-50 transition-colors border border-transparent hover:border-slate-100">
                            <div class="flex gap-4">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-primary">Maintenance Updates</p>
                                    <p class="text-xs text-slate-500">Status updates on requested furniture repairs</p>
                                </div>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                ...
                <section class="col-span-12 lg:col-span-5 bg-white rounded-xl shadow-sm border border-slate-100 p-8">
                    <div class="flex items-center gap-3 mb-8">
                        ...
                        <h3 class="font-h3 text-xl font-bold text-primary">Security</h3>
                    </div>
                    <div class="space-y-4">
                        ...
                        <div class="bg-slate-50 p-6 rounded-lg">
                            <p class="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-4">Active Sessions</p>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs font-medium">This Device - Current Session</span>
                                </div>
                                <span class="text-[10px] text-slate-400 uppercase font-bold">Active</span>
                            </div>
                        </div>
                        <button class="w-full text-red-500 text-sm font-semibold py-3 border border-red-100 rounded-lg hover:bg-red-50 transition-all">Sign Out from All Devices</button>
                    </div>
                </section>
            </div>
        </div>
