...
<main class="bg-slate-50 dark:bg-slate-950 min-h-screen">
    ...
    <section class="relative bg-[#041627] overflow-hidden py-24 md:py-32">
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-20">
            <div class="max-w-2xl">
                <span class="inline-block px-3 py-1 bg-teal-100 text-teal-800 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <button class="bg-teal-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-teal-500 transition-all shadow-lg shadow-teal-600/20 active:scale-95">
                        Become a Partner
                    </button>
                    <button class="border border-white/30 text-white font-bold px-8 py-4 rounded-xl hover:bg-white/10 transition-all backdrop-blur-sm">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center justify-between gap-12">
                <div class="flex flex-col">
                    <span class="text-3xl font-bold text-slate-900 dark:text-white">500+</span>
                    <span class="text-xs text-slate-500 uppercase tracking-widest">Active Vendors</span>
                </div>
                <div class="flex flex-wrap justify-center items-center gap-12 opacity-50 grayscale hover:grayscale-0 transition-all">
                    <div class="font-bold text-xl text-slate-400 italic">MODERN_HOME</div>
                    <div class="font-bold text-xl text-slate-400">VISTA LIVING</div>
                    <div class="font-bold text-xl text-slate-400 tracking-tighter">NordicSpace</div>
                    <div class="font-bold text-xl text-slate-400">URBANREST</div>
                    <div class="font-bold text-xl text-slate-400 italic">AURA</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-24 bg-slate-50 dark:bg-slate-950">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-slate-900 dark:text-white mb-4">Why Partner with RentEase?</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-8 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 hover:shadow-md transition-all group overflow-hidden">
                    <div class="flex flex-col md:flex-row gap-8 items-center h-full">
                        <div class="flex-1">
                            ...
                            <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">Effortless Logistics</h3>
                ...
                <div class="md:col-span-4 bg-[#041627] p-8 rounded-2xl shadow-sm group">
                    ...
                    <h3 class="text-2xl font-bold text-white mb-4">Guaranteed Income</h3>
                ...
                <div class="md:col-span-4 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
                    ...
                    <h3 class="text-2xl font-bold text-slate-900 dark:text-white mb-4">Automated Care</h3>
                ...
                <div class="md:col-span-8 bg-teal-50 dark:bg-teal-900/10 p-8 rounded-2xl shadow-sm border border-teal-100 dark:border-teal-900/30 flex flex-col md:flex-row justify-between items-center gap-8">
                    <div class="max-w-md">
                        <h3 class="text-2xl font-bold text-teal-900 dark:text-teal-100 mb-4">Actionable Analytics</h3>
    ...
    <section class="py-24 bg-white dark:bg-slate-900 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
            <div class="max-w-3xl mx-auto">
                <h2 class="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">Ready to grow your rental business?</h2>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button class="bg-[#041627] dark:bg-teal-600 text-white font-bold px-10 py-4 rounded-xl shadow-xl hover:brightness-110 transition-all active:scale-95">
                        Join RentEase Today
                    </button>
                    <button class="border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white font-bold px-10 py-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all active:scale-95">
                        Schedule a Demo
                    </button>
                </div>
                <p class="mt-8 text-sm text-slate-400 flex items-center justify-center gap-2">
