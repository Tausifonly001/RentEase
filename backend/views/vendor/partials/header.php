...
/**
 * Vendor Dashboard Header Partial
 * This partial only contains the navigation bar.
 */
        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center gap-4">
                <a href="<?= baseUrl('/') ?>" class="group flex items-center gap-2">
                    ...
                    <span class="text-xl font-black tracking-tighter text-slate-900">RentEase <span class="text-teal-600">Vendor</span></span>
                </a>
            </div>

            <div class="flex items-center gap-6">
                <div class="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-600">
                    <a href="<?= baseUrl('/vendor-panel') ?>" class="text-teal-600">Dashboard</a>
                    <a href="<?= baseUrl('/shop') ?>" class="hover:text-teal-600 transition-colors">View Shop</a>
                </div>
