...
<main class="pt-24 pb-20 px-4 md:px-8 max-w-4xl mx-auto min-h-screen">
    <!-- Header Section -->
    <div class="mb-12">
        <h1 class="text-4xl font-normal text-slate-900 dark:text-white mb-2">Maintenance Request</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <section class="md:col-span-8 bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800">
            <form action="api/maintenance/create.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                <!-- Rental Selection -->
                <div>
                    <label class="block text-xs font-light text-slate-500 uppercase tracking-widest mb-2">SELECT ACTIVE RENTAL</label>
                    <div class="relative">
                ...
                <!-- Problem Description -->
                <div>
                    <label class="block text-xs font-light text-slate-500 uppercase tracking-widest mb-2">DESCRIPTION OF THE ISSUE</label>
                ...
                <!-- Photo Upload -->
                <div>
                    <label class="block text-xs font-light text-slate-500 uppercase tracking-widest mb-2">UPLOAD PHOTOS</label>
                    <div class="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-2xl p-8 text-center flex flex-col items-center justify-center space-y-2 hover:border-teal-600 transition-colors cursor-pointer group">
                        ...
                        <p class="text-sm text-slate-600 dark:text-slate-400 font-light">Click to <span class="text-teal-600 font-normal">browse</span> or drag and drop images</p>
                        <p class="text-xs text-slate-400 font-light">Supports JPG, PNG up to 10MB</p>
                ...
                <!-- Scheduling -->
                <div>
                    <label class="block text-xs font-light text-slate-500 uppercase tracking-widest mb-2">PREFERRED TIME SLOT</label>
                ...
                <!-- Submit Button -->
                <div class="pt-4">
                    <button type="submit" class="w-full bg-[#041627] dark:bg-teal-600 text-white font-normal py-4 rounded-xl hover:opacity-90 active:scale-[0.98] transition-all shadow-lg">
        ...
        <aside class="md:col-span-4 space-y-6">
            <div class="bg-teal-50 dark:bg-teal-900/10 rounded-2xl p-6 border border-teal-100 dark:border-teal-800/30">
                <h3 class="text-xl font-normal text-teal-900 dark:text-teal-100 mb-4">What happens next?</h3>
                <ul class="space-y-6">
                    <li class="flex gap-4">
                        <div class="h-8 w-8 bg-teal-600 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-light">1</div>
                        <p class="text-sm text-slate-700 dark:text-slate-300 font-light">Our team reviews your request within 2 hours during business hours.</p>
                    </li>
                    <li class="flex gap-4">
                        <div class="h-8 w-8 bg-teal-600 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-light">2</div>
                        <p class="text-sm text-slate-700 dark:text-slate-300 font-light">A technician is assigned and your time slot is confirmed via SMS.</p>
                    </li>
                    <li class="flex gap-4">
                        <div class="h-8 w-8 bg-teal-600 text-white rounded-full flex items-center justify-center flex-shrink-0 text-sm font-light">3</div>
                        <p class="text-sm text-slate-700 dark:text-slate-300 font-light">Technician arrives and resolves the issue. No hidden repair fees for normal wear.</p>
                    </li>
                </ul>
            </div>
