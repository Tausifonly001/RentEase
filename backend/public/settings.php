...
<div class="max-w-7xl mx-auto flex min-h-screen">
 ...
 <span class="material-symbols-outlined text-champagne-dark">badge</span>
 ...
 <span class="inline-block bg-champagne px-2 py-1 text-[10px] font-normal tracking-widest uppercase mb-4" style="border-radius: 0.25rem;">Current Plan</span>
 ...
 <div class="flex items-center gap-3 mb-8">
 <span class="material-symbols-outlined text-champagne-dark">settings_suggest</span>
 ...
 <div class="w-11 h-6 bg-canvas peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-secondary"></div>
 </label>
 </div>
 <div class="flex items-center justify-between p-4 hover:bg-canvas transition-colors border border-transparent hover:border-[rgba(231,229,228,0.6)]" style="border-radius: 0.5rem;">
 <div class="flex gap-4">
 ...
 <div class="flex items-center gap-3 mb-8">
 <span class="material-symbols-outlined text-champagne-dark">lock</span>
