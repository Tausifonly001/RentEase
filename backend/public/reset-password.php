...
<body class="bg-[#F8FAFC] font-sans min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
 ...
 <div class="mb-8">
 <h2 class="text-2xl font-normal text-ink mb-2">New Password</h2>
 <p class="text-muted text-sm leading-relaxed font-light">Please choose a strong password to secure your account.</p>
 </div>
 ...
 <div class="space-y-2">
 <label for="password" class="block text-sm font-light text-ink">New Password</label>
 <div class="relative">
 <span class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-muted-light text-xl">lock</span>
 ...
 <p class="text-[10px] text-muted-light">Min. 6 characters with letters and numbers</p>
 </div>

 <div class="space-y-2">
 <label for="confirm_password" class="block text-sm font-light text-ink">Confirm Password</label>
 <div class="relative">
 <span class="absolute left-4 top-1/2 -translate-y-1/2 material-symbols-outlined text-muted-light text-xl">verified_user</span>
