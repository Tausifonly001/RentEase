...
<div class="max-w-7xl mx-auto flex min-h-screen">
    ...
    <aside class="hidden md:flex w-64 border-r border-slate-200 bg-slate-50 flex-col p-4 gap-2">
        <div class="mb-6 px-4 pt-4">
            ...
            <p class="text-xs text-slate-500 font-light">Manage your account & billing</p>
        </div>
        <nav class="space-y-1">
            ...
            <a class="bg-teal-50 text-teal-700 font-normal rounded-lg px-4 py-3 flex items-center gap-3 border-l-4 border-teal-600 transition-all" href="payment-methods.php">
        ...
        <div class="max-w-4xl mx-auto space-y-10">
            ...
            <section>
                <div class="flex items-center justify-between mb-8">
                    <h1 class="text-3xl font-normal text-primary tracking-tight">Payment Methods</h1>
                    <button class="flex items-center gap-2 px-6 py-2.5 bg-secondary text-white rounded-lg font-normal hover:brightness-110 transition-all shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white border-2 border-teal-100 rounded-2xl p-6 shadow-sm relative overflow-hidden group">
                        <div class="absolute top-4 right-4">
                            <span class="bg-teal-100 text-teal-800 text-[10px] font-normal px-3 py-1 rounded-full uppercase tracking-widest">Primary</span>
                        </div>
                        <div class="flex flex-col h-full justify-between gap-12">
                            ...
                            <div>
                                <p class="font-mono text-xl text-primary tracking-[0.2em] mb-2 font-normal">•••• •••• •••• 4242</p>
                                <div class="flex justify-between items-end">
                                    <div>
                                        <p class="text-[10px] text-slate-400 uppercase font-normal tracking-widest mb-1">Expires</p>
                                        <p class="text-sm font-light">12/26</p>
                                    </div>
                                    <p class="text-sm font-light text-slate-400">Visa Debit</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:border-teal-200 transition-colors group">
                        <div class="flex flex-col h-full justify-between gap-12">
                            ...
                            <div>
                                <p class="font-mono text-xl text-primary tracking-[0.2em] mb-2 font-normal">•••• •••• •••• 8890</p>
                                <div class="flex justify-between items-end">
                                    <div>
                                        <p class="text-[10px] text-slate-400 uppercase font-normal tracking-widest mb-1">Expires</p>
                                        <p class="text-sm font-light">08/25</p>
                                    </div>
                                    <p class="text-sm font-light text-slate-400">Mastercard Credit</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                <div class="px-8 py-5 border-b border-slate-100 flex items-center justify-between bg-slate-50">
                    <h3 class="text-sm font-light text-primary uppercase tracking-widest">Recent Invoices</h3>
                    <a class="text-teal-600 text-xs font-light hover:underline underline-offset-4" href="<?= baseUrl('/dashboard') ?>">View All History</a>
                </div>
                <div class="divide-y divide-slate-100">
                    ...
                    <div class="px-8 py-6 flex flex-wrap items-center justify-between gap-4 hover:bg-slate-50/50 transition-colors">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-normal text-primary">Invoice #RE-2024-008</p>
                                <p class="text-xs text-slate-400 font-light">Aug 01, 2024 • Monthly Subscription</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-8">
                            <span class="font-normal text-primary">$184.50</span>
                            <button class="flex items-center gap-2 text-teal-600 hover:bg-teal-50 px-4 py-2 rounded-lg transition-all font-light text-sm">
                    ...
                    <div class="px-8 py-6 flex flex-wrap items-center justify-between gap-4 hover:bg-slate-50/50 transition-colors">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <p class="font-normal text-primary">Invoice #RE-2024-007</p>
                                <p class="text-xs text-slate-400 font-light">Jul 01, 2024 • Monthly Subscription</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-8">
                            <span class="font-normal text-primary">$184.50</span>
