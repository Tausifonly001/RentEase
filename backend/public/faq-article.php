...
<main class="pt-8 pb-12 max-w-7xl mx-auto px-4 md:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-gutter">
        ...
        <aside class="hidden lg:block lg:col-span-3 space-y-8">
            <div class="sticky top-24">
                ...
                <ul class="space-y-3 font-body-sm text-on-surface-variant border-l-2 border-slate-100">
                    <li><a class="block pl-4 py-1 border-l-2 -ml-[2px] border-secondary text-secondary font-semibold" href="#initiate">Initiating Return</a></li>
        ...
        <article class="lg:col-span-6 bg-white p-6 md:p-10 rounded-xl shadow-sm border border-slate-50">
            <h1 class="font-h1 text-primary text-3xl md:text-4xl mb-6 leading-tight font-bold tracking-tight">How do I return my furniture at the end of a lease?</h1>
            
            <div class="flex items-center space-x-4 mb-8 text-on-surface-variant text-sm">
            ...
            <div class="font-body-lg text-on-surface space-y-6 leading-relaxed">
                ...
                <h2 class="font-h2 text-primary text-2xl font-bold mt-12 mb-4" id="initiate">1. Initiating the Return</h2>
                ...
                <h2 class="font-h2 text-primary text-2xl font-bold mt-12 mb-4" id="inspection">2. Pre-pickup Inspection</h2>
                ...
                <div class="bg-teal-50 border-l-4 border-secondary p-6 my-8 rounded-r-lg">
                    <p class="font-bold text-teal-800 mb-2 flex items-center gap-2">
                        <span class="material-symbols-outlined">lightbulb</span>
                        Pro Tip:
                    </p>
                    <p class="text-sm text-teal-700 leading-relaxed">Taking clear photos of your items 48 hours before pickup can serve as helpful documentation for your final inspection report.</p>
                </div>

                <h2 class="font-h2 text-primary text-2xl font-bold mt-12 mb-4" id="pickup">3. Scheduling Logistics</h2>
                ...
                <h2 class="font-h2 text-primary text-2xl font-bold mt-12 mb-4" id="security">4. Security Deposit Refund</h2>
            ...
            <div class="mt-16 pt-8 border-t border-slate-100 text-center">
                <p class="font-h3 text-lg mb-6 font-semibold">Was this article helpful?</p>
                <div class="flex justify-center space-x-4">
                    <button class="flex items-center px-6 py-2 border border-slate-200 rounded-full hover:bg-slate-50 transition-colors font-button text-primary font-medium">
        ...
        <aside class="lg:col-span-3 space-y-6">
            <div class="bg-primary text-white rounded-xl p-8 shadow-xl">
                ...
                <div class="mt-8 pt-8 border-t border-white/10 text-center">
                    ...
                    <p class="font-h3 text-xl font-bold">1-800-RENTEASE</p>
                </div>
            </div>
        </aside>
    </div>
