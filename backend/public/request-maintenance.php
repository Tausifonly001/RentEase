...
<main class="pt-24 pb-20 px-4 md:px-8 max-w-4xl mx-auto min-h-screen">
 ...
 <!-- Photo Upload -->
 <div>
 <label class="block text-xs font-light text-muted uppercase tracking-widest mb-2">UPLOAD PHOTOS</label>
 <div class="border-2 border-dashed border-border rounded-2xl p-8 text-center flex flex-col items-center justify-center space-y-2 hover:border-champagne transition-colors cursor-pointer group">
 <span class="material-symbols-outlined text-4xl text-muted-light group-hover:text-teal-600 transition-colors">cloud_upload</span>
 <p class="text-sm text-ink font-light">Click to <span class="text-champagne-dark font-normal">browse</span> or drag and drop images</p>
 <p class="text-xs text-muted-light font-light">Supports JPG, PNG up to 10MB</p>
