...
<main class="pt-24 pb-16 max-w-4xl mx-auto px-8 min-h-screen flex flex-col justify-center">
    <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden reveal-element">
        <!-- Progress Bar -->
        <div class="h-1.5 w-full bg-slate-50">
            <div id="survey-progress" class="h-full w-1/3 bg-secondary rounded-r-full transition-all duration-1000"></div>
        </div>
    ...
    stars.forEach((btn, index) => {
        btn.addEventListener('click', () => {
            ...
            stars.forEach((s, i) => {
                ...
                icon.classList.toggle('text-secondary', i <= index);
                icon.classList.toggle('text-slate-300', i > index);
            });
